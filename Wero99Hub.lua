...
local Window = Rayfield:CreateWindow({
    Name = "99 Nights WeroScript",
    LoadingTitle = "99 Nights Script",
    LoadingSubtitle = "by WeroScript",
    ConfigurationSaving = {
        Enabled = true,
        FolderName = nil,
...
CreditsTab:CreateLabel("👑 Diseñador: WeroScripts")
CreditsTab:CreateLabel("💻 Scripter: WeroScripts")
CreditsTab:CreateLabel("🌐 Servidor de Discord Oficial:")

-- 📋 Botón para copiar Discord
CreditsTab:CreateButton({
   Name = "Copiar Discord (discord.gg/EmsvzWF3xK)",
   Callback = function()
       if setclipboard then
           setclipboard("https://discord.gg/EmsvzWF3xK")
           Rayfield:Notify({
              Title = "✅ Copiado",
              Content = "El enlace del servidor se copió al portapapeles.",
              Duration = 4
           })
       else
           Rayfield:Notify({
              Title = "⚠️ Error",
              Content = "Tu exploit no soporta setclipboard.",
              Duration = 4
           })
       end
   end,
